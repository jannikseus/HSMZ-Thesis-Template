...
% Die Datei 00_ThesisContent dient als zentrale Datei, in der die Struktur der Arbeit definiert und einzelne Abschnitte eingeladen werden.
%
...
Insbesondere \ac{ML} ist dabei interessant, da dort noch eine deutsche Übersetzung angegeben ist. Abkürzungen werden im Vortext in \texttt{06_Abbreviations.tex} definiert und automatisch in das Abkürzungsverzeichnis aufgenommen, wenn diese in der Arbeit verwendet werden.
...
Die Quellen werden in \texttt{Thesis.tex} eingeladen.
...
Dieser Workaround wird am Beispiel von \cref{fig:example} vorgestellt. Zur Übersichtlichkeit wurde für Artefakte ein Verzeichnis 04\_Artifacts angelegt.
...
\input{04_Artifacts/02_Tables/ShortSample}
...
Die eigentliche Definition der Nomenklatur erfolgt in \texttt{Nomenclature.tex} im \texttt{Verzeichnis 00\_General}.
...
\input{04_Artifacts/04_Algorithms/Algorithm_Example}
...
\label{listing:1}
\inputminted{java}{04_Artifacts/03_Listings/HelloWorld.java}
\end{listing}
