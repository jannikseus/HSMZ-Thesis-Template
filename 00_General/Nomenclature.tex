...
% Die Datei Nomenclature.tex dient der zentralen Definition der Nomenklatur, d.h. Beschreibung der verwendeten Symbole.
...
\nomenclature[aA]A{Beispielinhalt für die Variable}
\nomenclature[xA]A{Beispielinhalt für die Variable}
\nomenclature[zA]A{Beispielinhalt für die Variable}
\nomenclature[ge]{$\epsilon_0$}{elektrische Feldkonstante\nomunit{\ampere\second\per\volt\per\meter}}
\nomenclature[gl]{$\lambda$}{Beispielinhalt für die Variable\nomunit{\per\square\meter\per\second\kelvin\per\kilogram}}